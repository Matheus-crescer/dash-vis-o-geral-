...
function computeFromOrders(orders, extra){
  ...
  return {
    ...
    orders: orders.map(o=>[o.dataLabel,o.cidade,o.uf,o.pagamento,o.canal||'—',o.entrega,normStatus(o.status),o.cupom||'—',o.itens,round2(o.valor),round2(o.frete||0),o.dataKey]),
